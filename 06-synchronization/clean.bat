@echo off
echo === OpenMP Synchronization Clean Script ===

:: Check for open processes
echo Checking for processes that might lock files...
taskkill /f /im OpenMP_Synchronization.exe 2>nul
...
if exist sync_benchmark_results.txt del sync_benchmark_results.txt
