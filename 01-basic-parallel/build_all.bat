@echo off
echo === OpenMP Basic Parallel Build Script ===
...
:: Profile configuration is not needed for basic parallel - it's a specialized configuration not in CMake by default
echo.
